...
var app = {
    ...
    playSound: function(srcSound){
      ...
      init: function() {
        ...
        for (var li = 0; li < classnameLess.length; li++) {
            classnameLess[li].addEventListener('click', app.lessValue);    
            classnameLess[li].addEventListener('mousedown', app.lessValueCont);
            classnameLess[li].addEventListener('touchstart', app.lessValueCont);
            classnameLess[li].addEventListener('mouseup', app.contEnd);
            classnameLess[li].addEventListener('touchend', app.contEnd);            
        }
    ...
    initChrono: function() {
        ...
        app.setDiv.classList.add("hide");
        app.chronoDiv.classList.remove("hide");
        app.state = 2;
        ...
        /* TODO refactorizar */
        app.cycle.innerText = (app.workFinish + 1) + "/" + app.setsValue.innerText;
